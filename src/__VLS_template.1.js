...
import select from './components/InputComponents/FormSelect/select.vue';
...
const __VLS_11 = __VLS_asFunctionalComponent(__VLS_10, new __VLS_10({ ...{}, modelValue: ((__VLS_ctx.tinputValue)), }));
({} as { tinput: typeof __VLS_10; }).tinput;
const __VLS_12 = __VLS_11({ ...{}, modelValue: ((__VLS_ctx.tinputValue)), }, ...__VLS_functionalComponentArgsRest(__VLS_11));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_10, typeof __VLS_12> & Record<string, unknown>) => void)({ ...{}, modelValue: ((__VLS_ctx.tinputValue)), });
...
const __VLS_16 = __VLS_asFunctionalComponent(__VLS_15, new __VLS_15({ ...{}, modelValue: ((__VLS_ctx.emailValue)), }));
({} as { email: typeof __VLS_15; }).email;
const __VLS_17 = __VLS_16({ ...{}, modelValue: ((__VLS_ctx.emailValue)), }, ...__VLS_functionalComponentArgsRest(__VLS_16));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_15, typeof __VLS_17> & Record<string, unknown>) => void)({ ...{}, modelValue: ((__VLS_ctx.emailValue)), });
...
const __VLS_21 = __VLS_asFunctionalComponent(__VLS_20, new __VLS_20({ ...{}, modelValue: ((__VLS_ctx.passwordValue)), }));
({} as { password: typeof __VLS_20; }).password;
const __VLS_22 = __VLS_21({ ...{}, modelValue: ((__VLS_ctx.passwordValue)), }, ...__VLS_functionalComponentArgsRest(__VLS_21));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_20, typeof __VLS_22> & Record<string, unknown>) => void)({ ...{}, modelValue: ((__VLS_ctx.passwordValue)), });
...
const __VLS_26 = __VLS_asFunctionalComponent(__VLS_25, new __VLS_25({ ...{}, modelValue: ((__VLS_ctx.numberValue)), }));
({} as { number: typeof __VLS_25; }).number;
const __VLS_27 = __VLS_26({ ...{}, modelValue: ((__VLS_ctx.numberValue)), }, ...__VLS_functionalComponentArgsRest(__VLS_26));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_25, typeof __VLS_27> & Record<string, unknown>) => void)({ ...{}, modelValue: ((__VLS_ctx.numberValue)), });
...
const __VLS_31 = __VLS_asFunctionalComponent(__VLS_30, new __VLS_30({ ...{}, modelValue: ((__VLS_ctx.fileValue)), }));
({} as { file: typeof __VLS_30; }).file;
const __VLS_32 = __VLS_31({ ...{}, modelValue: ((__VLS_ctx.fileValue)), }, ...__VLS_functionalComponentArgsRest(__VLS_31));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_30, typeof __VLS_32> & Record<string, unknown>) => void)({ ...{}, modelValue: ((__VLS_ctx.fileValue)), });
...
const __VLS_42 = __VLS_41({ ...{}, value: ((__VLS_ctx.select)), }, ...__VLS_functionalComponentArgsRest(__VLS_41));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_40, typeof __VLS_42> & Record<string, unknown>) => void)({ ...{}, value: ((__VLS_ctx.select)), });
...
var __VLS_slots!: {};
// @ts-ignore
[tinputValue, tinputValue, tinputValue, emailValue, emailValue, emailValue, passwordValue, passwordValue, passwordValue, numberValue, numberValue, numberValue, fileValue, fileValue, fileValue, datatime, datatime, datatime, select, select,];
return __VLS_slots;
}
